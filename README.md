...
An interactive catalog of four frameless base cabinets. Every carcass board, front, drawer-box board, slide section, hinge component, and pull is generated procedurally as an individual Three.js part; assemblies are never resized with a global scale.
...
The VS30 Vanity Sink Base uses the reference's 30-in nominal width and an assumed 21-in vanity depth because no overall depth was supplied. It has an open, unobstructed sink/plumbing bay, paired slab false fronts, paired slab doors, four concealed hinges, and two pulls; a shelf, center divider, working drawers, drawer boxes, and slides are intentionally omitted to match the supplied views.
